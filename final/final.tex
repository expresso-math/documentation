...
In essence, Roaster is a set of methods that use the Python Imaging Library (PIL)\footnote{http://www.pythonware.com/products/pil/‎} and OpenCV\footnote{http://opencv.org/} libraries to 
